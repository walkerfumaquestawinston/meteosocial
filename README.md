...
Per ricostruire `index.html`: concatenare `styles-and-head.html` + `markup.html` + `<script src=three.js r128>` + `<script>data.js</script>` + `<script>app.js</script>` + `<script>app-social-3d-ai.js</script>` + `<script>app-v3.js</script>`.
