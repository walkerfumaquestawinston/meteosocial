...
files.push('map-hail-radar.js','assets/geotiff.js','assets/proj4.js','assets/GEOTIFF-LICENSE.txt','assets/PROJ4-LICENSE.txt','map-basemap.js','map-provider.js','map-local-brief.js','map-cockpit.css','map-workspace.css','map-live-status.js','map-live.css','next-change.js','next-change.css','weather-scene.js','weather-scene.css','season-design.css','calendar-theme.js','season-dates.js','cielo-design.css','assets/cielo-atmosphere.webp','map-field-core.js','map-field-desk.js','map-weather-source.js','map-visuals.js','map-city-labels.js','map-land.js','map-radar.js','map-weather-core.js','mappa-eventi-controller.js','mappa-eventi.js','mappa-eventi.css','map-field.css','profession.js','daily-question.js','forecast-receipt.js','weather-page.js','weather-labels.js','app-updates.js','map-outline.js','map-radar-check.js');
