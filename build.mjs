...
files.push('mappa-eventi.js','mappa-eventi.css','profession.js','daily-question.js','forecast-receipt.js','weather-page.js','weather-labels.js','app-updates.js','map-outline.js','map-radar-check.js');
fs.rmSync('dist/app',{recursive:true,force:true});
const bundle=await build({entryPoints:['dist/main.js'],outdir:'dist/app',bundle:true,splitting:true,format:'esm',minify:true,target:'es2022',metafile:true,entryNames:'main',chunkNames:'[name]-[hash]'});
...
const styles=['design.css','social.css','global.css','experience.css','sensory.css','refinements.css','network.css','assets/leaflet.css','atlas.css','pulse.css','editorial.css','fitcheck.css','lente.css','atmosphere.css','living-world.css','design-system.css','local-map.css','mappa-eventi.css'];
