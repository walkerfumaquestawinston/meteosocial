...
export function nowcastMarkup(data,state='loading',error=''){
 ...
 if(state==='error')return '<section class="rain-nowcast"><h3>Pioggia, minuto per minuto</h3><p>'+esc(error||'Rainbow temporaneamente non disponibile.')+'</p><small>Dato assente non significa assenza di pioggia.</small></section>';
