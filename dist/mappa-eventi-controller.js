...
export function createMappaEventi(ctx) {
  ...
  function renderSelected(){
    ...
    if(!overviewOpen&&el.offsetHeight)$('#mappa-pulse').style.top=(el.offsetTop+el.offsetHeight+12)+'px';
  }
