...
export function createMappaEventi(ctx) {
  ...
  function visibility(){renderFreshness();if(!document.hidden){load();fieldDesk?.refresh();if(radarState.enabled)radar?.refresh();}}
  async function bind(){
